...
#[derive(Debug)]
pub struct BandProtocolProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BandProtocolProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BandProtocol processing");
    
    let mut processor = BandProtocolProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BandProtocolProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BandProtocolProcessor::new(false);
